...
//        use switch statements when you have multiple items in the menu
        if(selected_id == R.id.action_search) {
            String message = "Search button clicked";
            Context context = MainActivity.this;
            Toast new_toast = Toast.makeText(context, message, Toast.LENGTH_LONG);
            new_toast.show();
        }
        return true;
    }

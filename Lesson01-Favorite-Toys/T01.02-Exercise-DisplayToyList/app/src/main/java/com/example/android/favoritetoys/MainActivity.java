...
//        // The usual C way to loop through strings
//        for (int i = 0; i < toyList.length; mToysListTextView.append(toyList[i++]));
        // better way to loop through string arrays
        for( String current_toy : toyList) mToysListTextView.append(current_toy + "\n\n");
    }
}